...
namespace Generics.Robots
{
    ...
    {
        public static Robot<TCommand> Create<TCommand>(IRobotAI<TCommand> ai, IDevice<TCommand> device)
        {
            return Robot<TCommand>.Create(ai, device);
        }
    }
    ...
    {
        public string ExecuteCommand(IMoveCommand command) // MoveCommand _command
        {
            if (command == null)
    ...
    public class Robot<TCommand>
    {
        ...
        private Robot(IRobotAI<TCommand> ai, IDevice<TCommand> executor)
        {
            _ai = ai;
            _device = executor;
        }
        ...
        public static Robot<TCommand> Create(IRobotAI<TCommand> ai, IDevice<TCommand> executor)
        {
